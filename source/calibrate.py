...
#adjust videocapture
#adjust chessboard_size
#adjust directory reading
...
def calibrate():
    ...
    (leftFilenames, leftObjectPoints, leftImagePoints, leftSize
            ) = readImagesAndFindChessboards("/home/pi/images/left")
    (rightFilenames, rightObjectPoints, rightImagePoints, rightSize
            ) = readImagesAndFindChessboards("/home/pi/images/right")
    ...
    return leftMapX, leftMapY,rightMapX, rightMapY, leftROI, rightROI, imageSize
